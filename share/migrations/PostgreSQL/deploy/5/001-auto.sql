-- Allani schema version 5
--
-- Full schema at version 5: syslog + http_access + http_error, the raw GIN
-- indexes (v4), and the default search indexes (v5): composite (column, id)
-- btrees for "newest N matching a filter" and timestamp btrees for --since /
-- prune. `raw` is the primary datum ({ MESSAGE, enriched }); the other columns
